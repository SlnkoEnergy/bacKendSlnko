...
const { createExpense, getAllExpense, getExpenseById, deleteExpense, updateExpenseStatusOverall, updateExpenseStatusItems, exportAllExpenseSheetsCSV, exportExpenseSheetsCSVById, updateExpenseSheet, updateDisbursementDate, getExpensePdf } = require("../Controllers/expenseSheetControllers/expenseSheetController");
...
router.get("/expense-pdf/:_id", jwtMW.authentication, jwtMW.authorization, getExpensePdf)
